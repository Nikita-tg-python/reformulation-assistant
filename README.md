...
|---|---|
| `search_knowledge_base(query, top_k)` | векторний пошук, як у `/ask`: один результат на документ (`top_k` ≤ 3), текст до 500 символів, для специфікацій також `nutrients_per_100g` |
